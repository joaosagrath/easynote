	...
	<body>
		...
		<form method="post" action="cadastrar.php">
			...
			<div>
				...
				<input type="text" id="nome" name="nome" style="width: 200px;" placeholder="Nome">
				
				<!-- Javascript captura valores dos elementos pelo ID - PHP captura os valores dos elementos pelo NAME -->
				<input type="text" id="sobrenome" name="sobrenome" style="width: 200px;" placeholder="Sobrenome">
